...
class ProjectReleaseList(View):
    def get(self, request, *args, **kwargs):
        ...
        can_delete_files = has_permission(
            request.user, Permission.RELEASE_FILE_DELETE, project=project
        )
        can_view_files = has_permission(
            request.user, Permission.RELEASE_FILE_VIEW, project=project
        )
...
class WorkspaceReleaseList(View):
    def get(self, request, *args, **kwargs):
        ...
        can_delete_files = has_permission(
            request.user, Permission.RELEASE_FILE_DELETE, project=workspace.project
        )
        can_view_files = has_permission(
            request.user,
            Permission.RELEASE_FILE_VIEW,
