By applying to use OpenSAFELY you are declaring that you need patient level access, (even though you won’t directly see those patient level cohort tables in the OpenSAFELY TRE model). 
