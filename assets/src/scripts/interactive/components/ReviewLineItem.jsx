  ...
  return (
    <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
      ...
      <dd className="mt-1 flex text-gray-900 sm:col-span-2 sm:mt-0">
        <span className="grow break-words">{children}</span>
        <span className="ml-4 shrink-0">
          <button
            className="rounded-md bg-white font-medium text-oxford-600 hover:text-oxford-500 focus:outline-hidden focus:ring-2 focus:ring-oxford-500 focus:ring-offset-2"
