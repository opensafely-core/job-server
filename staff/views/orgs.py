...
def org_add_github_org(request, slug):
    ...
    if request.GET or not form.is_valid():
        return TemplateResponse(
            ...
            request=request,
            template="staff/orgs/add_github_orgs.htmx.html",
        )
...
class OrgCreate(CreateView):
    ...
    def get_template_names(self):
        ...
        template_name = f"staff/orgs/create{suffix}.html"
...
class OrgDetail(FormView):
    ...
    template_name = "staff/orgs/detail.html"
...
class OrgEdit(UpdateView):
    ...
    model = Org
    template_name = "staff/orgs/edit.html"
...
class OrgList(ListView):
    ...
    template_name = "staff/orgs/list.html"
...
class OrgProjectCreate(CreateView):
    fields = ["name"]
    model = Project
    template_name = "staff/orgs/project_create.html"
